...
def createData(iter):
    ...
    #Save the data
    print ("Saving data for 1000 pre-change days, 10Simulations, iteration#:",iter)
    np.save(('/home/smriti.prathapan/note1/GaussData-March0724/D86-Mar10/%d-Gaussian86-10S-1000D.npy' %iter), GaussianSamples86) # save
